...
<div style="padding-top: 30px; background-color: #d5d8db ;font-size: 20px ;text-align: center ; padding-bottom: 30px ; font-family: 'Segoe Print'; font-weight: bold"> <?= $this->fetch('title') ?></div>
    <main class="main">
        <div class="container">
